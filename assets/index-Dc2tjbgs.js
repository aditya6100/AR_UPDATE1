...
}`;function MT(t,e,n){let i=new Qd;const r=new Be,s=new Be,o=new at,a=new WS({depthPacking:ky}),l=new XS,c={},h=n.maxTextureSize,f={[Ji]:cn,[cn]:Ji,[zn]:zn},d=new er({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Be},radius:{value:4}},vertexShader:yT,fragmentShader:ST}),p=d.clone();p.defines.HORIZONTAL_PASS=1;const _=new Yn;_.setAttribute("position",new ii(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const g=new Kt(_,d),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Gg;let u=this.type;this.render=function(R,A,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const w=t.getRenderTarget(),M=t.getActiveCubeFace(),D=t.getActiveMipmapLevel(),k=t.state;k.setBlending($i),k.buffers.depth.getReversed()===!0?k.buffers.color.setClear(0,0,0,0):k.buffers.color.setClear(1,1,1,1),k.buffers.depth.setTest(!0),k.setScissorTest(!1);const H=u!==di&&this.type===di,V=u===di&&this.type!==di;for(let O=0,z=R.length;O<z;O++){const Y=R[O],L=Y.shadow;if(L===void 0){console.warn("THREE.WebGLShadowMap:",Y,"has no shadow.");continue}if(L.autoUpdate===!1&&L.needsUpdate===!1)continue;r.copy(L.mapSize);const X=L.getFrameExtents();if(r.multiply(X),s.copy(L.mapSize),(r.x>h||r.y>h)&&(r.x>h&&(s.x=Math.floor(h/X.x),r.x=s.x*X.x,L.mapSize.x=s.x),r.y>h&&(s.y=Math.floor(h/X.y),r.y=s.y*X.y,L.mapSize.y=s.y)),L.map===null||H===!0||V===!0){const K=this.type!==di?{minFilter:Xn,magFilter:Xn}:{};L.map!==null&&L.map.dispose(),L.map=new Lr(r.x,r.y,K),L.map.texture.name=Y.name+".shadowMap",L.camera.updateProjectionMatrix()}t.setRenderTarget(L.map),t.clear();const Q=L.getViewportCount();for(let K=0;K<Q;K++){const ee=L.getViewport(K);o.set(s.x*ee.x,s.y*ee.y,s.x*ee.z,s.y*ee.w),k.viewport(o),L.updateMatrices(Y,K),i=L.getFrustum(),y(A,P,L.camera,Y,this.type)}L.isPointLightShadow!==!0&&this.type===di&&v(L,P),L.needsUpdate=!1}u=this.type,m.needsUpdate=!1,t.setRenderTarget(w,M,D)};function v(R,A){const P=e.update(g);d.defines.VSM_SAMPLES!==R.blurSamples&&(d.defines.VSM_SAMPLES=R.blurSamples,p.defines.VSM_SAMPLES=R.blurSamples,d.needsUpdate=!0,p.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new Lr(r.x,r.y)),d.uniforms.shadow_pass.value=R.map.texture,d.uniforms.resolution.value=R.mapSize,d.uniforms.radius.value=R.radius,t.setRenderTarget(R.mapPass),t.clear(),t.renderBufferDirect(A,null,P,d,g,null),p.uniforms.shadow_pass.value=R.mapPass.texture,p.uniforms.resolution.value=R.mapSize,p.uniforms.radius.value=R.radius,t.setRenderTarget(R.map),t.clear(),t.renderBufferDirect(A,null,P,p,g,null)}function x(R,A,P,w){let M=null;const D=P.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(D!==void 0)M=D;else if(M=P.isPointLight===!0?l:a,t.localClippingEnabled&&A.clipShadows===!0&&Array.isArray(A.clippingPlanes)&&A.clippingPlanes.length!==0||A.displacementMap&&A.displacementScale!==0||A.alphaMap&&A.alphaTest>0||A.map&&A.alphaTest>0||A.alphaToCoverage===!0){const k=M.uuid,H=A.uuid;let V=c[k];V===void 0&&(V={},c[k]=V);let O=V[H];O===void 0&&(O=M.clone(),V[H]=O,A.addEventListener("dispose",T)),M=O}if(M.visible=A.visible,M.wireframe=A.wireframe,w===di?M.side=A.shadowSide!==null?A.shadowSide:A.side:M.side=A.shadowSide!==null?A.shadowSide:f[A.side],M.alphaMap=A.alphaMap,M.alphaTest=A.alphaToCoverage===!0?.5:A.alphaTest,M.map=A.map,M.clipShadows=A.clipShadows,M.clippingPlanes=A.clippingPlanes,M.clipIntersection=A.clipIntersection,M.displacementMap=A.displacementMap,M.displacementScale=A.displacementScale,M.displacementBias=A.displacementBias,M.wireframeLinewidth=A.wireframeLinewidth,M.linewidth=A.linewidth,P.isPointLight===!0&&M.isMeshDistanceMaterial===!0){const k=t.properties.get(M);k.light=P}return M}function y(R,A,P,w,M){if(R.visible===!1)return;if(R.layers.test(A.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&M===di)&&(!R.frustumCulled||i.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,R.matrixWorld);const H=e.update(R),V=R.material;if(Array.isArray(V)){const O=H.groups;for(let z=0,Y=O.length;z<Y;z++){const L=O[z],X=V[L.materialIndex];if(X&&X.visible){const Q=x(R,X,w,M);R.onBeforeShadow(t,R,A,P,H,Q,L),t.renderBufferDirect(P,null,H,Q,R,L),R.onAfterShadow(t,R,A,P,H,Q,L)}}}else if(V.visible){const O=x(R,V,w,M);R.onBeforeShadow(t,R,A,P,H,O,null),t.renderBufferDirect(P,null,H,O,R,null),R.onAfterShadow(t,R,A,P,H,O,null)}}const k=R.children;for(let H=0,V=k.length;H<V;H++)y(k[H],A,P,w,M)}function T(R){R.target.removeEventListener("dispose",T);for(const P in c){const w=c[P],M=R.target.uuid;M in w&&(w[M].dispose(),delete w[M])}}}const ET={[af]:lf,[cf]:df,[uf]:hf,[bs]:ff,[lf]:af,[df]:cf,[hf]:uf,[ff]:bs};function wT(t,e){function n(){let I=!1;const oe=new at;let ce=null;const ye=new at(0,0,0,0);return{setMask:function(ie){ce!==ie&&!I&&(t.colorMask(ie,ie,ie,ie),ce=ie)},setLocked:function(ie){I=ie},setClear:function(ie,J,Me,ze,ct){ct===!0&&(ie*=ze,J*=ze,Me*=ze),oe.set(ie,J,Me,ze),ye.equals(oe)===!1&&(t.clearColor(ie,J,Me,ze),ye.copy(oe))},reset:function(){I=!1,ce=null,ye.set(-1,0,0,0)}}}function i(){let I=!1,oe=!1,ce=null,ye=null,ie=null;return{setReversed:function(J){if(oe!==J){const Me=e.get("EXT_clip_control");J?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),oe=J;const ze=ie;ie=null,this.setClear(ze)}},getReversed:function(){return oe},setTest:function(J){J?Z(t.DEPTH_TEST):ae(t.DEPTH_TEST)},setMask:function(J){ce!==J&&!I&&(t.depthMask(J),ce=J)},setFunc:function(J){if(oe&&(J=ET[J]),ye!==J){switch(J){case af:t.depthFunc(t.NEVER);break;case lf:t.depthFunc(t.ALWAYS);break;case cf:t.depthFunc(t.LESS);break;case bs:t.depthFunc(t.LEQUAL);break;case uf:t.depthFunc(t.EQUAL);break;case ff:t.depthFunc(t.GEQUAL);break;case df:t.depthFunc(t.GREATER);break;case hf:t.depthFunc(t.NOTEQUAL);break;default:t.depthFunc(t.LEQUAL)}ye=J}},setLocked:function(J){I=J},setClear:function(J){ie!==J&&(oe&&(J=1-J),t.clearDepth(J),ie=J)},reset:function(){I=!1,ce=null,ye=null,ie=null,oe=!1}}}function r(){let I=!1,oe=null,ce=null,ye=null,ie=null,J=null,Me=null,ze=null,ct=null;return{setTest:function(nt){I||(nt?Z(t.STENCIL_TEST):ae(t.STENCIL_TEST))},setMask:function(nt){oe!==nt&&!I&&(t.stencilMask(nt),oe=nt)},setFunc:function(nt,oi,qn){(ce!==nt||ye!==oi||ie!==qn)&&(t.stencilFunc(nt,oi,qn),ce=nt,ye=oi,ie=qn)},setOp:function(nt,oi,qn){(J!==nt||Me!==oi||ze!==qn)&&(t.stencilOp(nt,oi,qn),J=nt,Me=oi,ze=qn)},setLocked:function(nt){I=nt},setClear:function(nt){ct!==nt&&(t.clearStencil(nt),ct=nt)},reset:function(){I=!1,oe=null,ce=null,ye=null,ie=null,J=null,Me=null,ze=null,ct=null}}}const s=new n,o=new i,a=new r,l=new WeakMap,c=new WeakMap;let h={},f={},d=new WeakMap,p=[],_=null,g=!1,m=null,u=null,v=null,x=null,y=null,T=null,R=null,A=new Qe(0,0,0),P=0,w=!1,M=null,D=null,k=null,H=null,V=null;const O=t.getParameter(t.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let z=!1,Y=0;const L=t.getParameter(t.VERSION);L.indexOf("WebGL")!==-1?(Y=parseFloat(/^WebGL (\d)/.exec(L)[1]),z=Y>=1):L.indexOf("OpenGL ES")!==-1&&(Y=parseFloat(/^OpenGL ES (\d)/.exec(L)[1]),z=Y>=2);let X=null,Q={};const K=t.getParameter(t.SCISSOR_BOX),ee=t.getParameter(t.VIEWPORT),je=new at().fromArray(K),Oe=new at().fromArray(ee);function be(I,oe,ce,ye){const ie=new Uint8Array(4),J=t.createTexture();t.bindTexture(I,J),t.texParameteri(I,t.TEXTURE_MIN_FILTER,t.NEAREST),t.texParameteri(I,t.TEXTURE_MAG_FILTER,t.NEAREST);for(let Me=0;Me<ce;Me++)I===t.TEXTURE_3D||I===t.TEXTURE_2D_ARRAY?t.texImage3D(oe,0,t.RGBA,1,1,ye,0,t.RGBA,t.UNSIGNED_BYTE,ie):t.texImage2D(oe+Me,0,t.RGBA,1,1,0,t.RGBA,t.UNSIGNED_BYTE,ie);return J}const j={};j[t.TEXTURE_2D]=be(t.TEXTURE_2D,t.TEXTURE_2D,1),j[t.TEXTURE_CUBE_MAP]=be(t.TEXTURE_CUBE_MAP,t.TEXTURE_CUBE_MAP_POSITIVE_X,6),j[t.TEXTURE_2D_ARRAY]=be(t.TEXTURE_2D_ARRAY,t.TEXTURE_2D_ARRAY,1,1),j[t.TEXTURE_3D]=be(t.TEXTURE_3D,t.TEXTURE_3D,1,1),s.setClear(0,0,0,1),o.setClear(1),a.setClear(0),Z(t.DEPTH_TEST),o.setFunc(bs),Ee(!1),ge(wp),Z(t.CULL_FACE),$e($i);function Z(I){h[I]!==!0&&(t.enable(I),h[I]=!0)}function ae(I){h[I]!==!1&&(t.disable(I),h[I]=!1)}function Te(I,oe){return f[I]!==oe?(t.bindFramebuffer(I,oe),f[I]=oe,I===t.DRAW_FRAMEBUFFER&&(f[t.FRAMEBUFFER]=oe),I===t.FRAMEBUFFER&&(f[t.DRAW_FRAMEBUFFER]=oe),!0):!1}function ue(I,oe){let ce=p,ye=!1;if(I){ce=d.get(oe),ce===void 0&&(ce=[],d.set(oe,ce));const ie=I.textures;if(ce.length!==ie.length||ce[0]!==t.COLOR_ATTACHMENT0){for(let J=0,Me=ie.length;J<Me;J++)ce[J]=t.COLOR_ATTACHMENT0+J;ce.length=ie.length,ye=!0}}else ce[0]!==t.BACK&&(ce[0]=t.BACK,ye=!0);ye&&t.drawBuffers(ce)}function Le(I){return _!==I?(t.useProgram(I),_=I,!0):!1}const Ye={[mr]:t.FUNC_ADD,[uy]:t.FUNC_SUBTRACT,[fy]:t.FUNC_REVERSE_SUBTRACT};Ye[dy]=t.MIN,Ye[hy]=t.MAX;const b={[py]:t.ZERO,[my]:t.ONE,[_y]:t.SRC_COLOR,[sf]:t.SRC_ALPHA,[My]:t.SRC_ALPHA_SATURATE,[yy]:t.DST_COLOR,[vy]:t.DST_ALPHA,[gy]:t.ONE_MINUS_SRC_COLOR,[of]:t.ONE_MINUS_SRC_ALPHA,[Sy]:t.ONE_MINUS_DST_COLOR,[xy]:t.ONE_MINUS_DST_ALPHA,[Ey]:t.CONSTANT_COLOR,[wy]:t.ONE_MINUS_CONSTANT_COLOR,[Ty]:t.CONSTANT_ALPHA,[Ay]:t.ONE_MINUS_CONSTANT_ALPHA};function $e(I,oe,ce,ye,ie,J,Me,ze,ct,nt){if(I===$i){g===!0&&(ae(t.BLEND),g=!1);return}if(g===!1&&(Z(t.BLEND),g=!0),I!==cy){if(I!==m||nt!==w){if((u!==mr||y!==mr)&&(t.blendEquation(t.FUNC_ADD),u=mr,y=mr),nt)switch(I){case ys:t.blendFuncSeparate(t.ONE,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Tp:t.blendFunc(t.ONE,t.ONE);break;case Ap:t.blendFuncSeparate(t.ZERO,t.ONE_MINUS_SRC_COLOR,t.ZERO,t.ONE);break;case Rp:t.blendFuncSeparate(t.DST_COLOR,t.ONE_MINUS_SRC_ALPHA,t.ZERO,t.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}else switch(I){case ys:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE_MINUS_SRC_ALPHA,t.ONE,t.ONE_MINUS_SRC_ALPHA);break;case Tp:t.blendFuncSeparate(t.SRC_ALPHA,t.ONE,t.ONE,t.ONE);break;case Ap:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case Rp:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",I);break}v=null,x=null,T=null,R=null,A.set(0,0,0),P=0,m=I,w=nt}return}ie=ie||oe,J=J||ce,Me=Me||ye,(oe!==u||ie!==y)&&(t.blendEquationSeparate(Ye[oe],Ye[ie]),u=oe,y=ie),(ce!==v||ye!==x||J!==T||Me!==R)&&(t.blendFuncSeparate(b[ce],b[ye],b[J],b[Me]),v=ce,x=ye,T=J,R=Me),(ze.equals(A)===!1||ct!==P)&&(t.blendColor(ze.r,ze.g,ze.b,ct),A.copy(ze),P=ct),m=I,w=!1}function Ue(I,oe){I.side===zn?ae(t.CULL_FACE):Z(t.CULL_FACE);let ce=I.side===cn;oe&&(ce=!ce),Ee(ce),I.blending===ys&&I.transparent===!1?$e($i):$e(I.blending,I.blendEquation,I.blendSrc,I.blendDst,I.blendEquationAlpha,I.blendSrcAlpha,I.blendDstAlpha,I.blendColor,I.blendAlpha,I.premultipliedAlpha),o.setFunc(I.depthFunc),o.setTest(I.depthTest),o.setMask(I.depthWrite),s.setMask(I.colorWrite);const ye=I.stencilWrite;a.setTest(ye),ye&&(a.setMask(I.stencilWriteMask),a.setFunc(I.stencilFunc,I.stencilRef,I.stencilFuncMask),a.setOp(I.stencilFail,I.stencilZFail,I.stencilZPass)),de(I.polygonOffset,I.polygonOffsetFactor,I.polygonOffsetUnits),I.alphaToCoverage===!0?Z(t.SAMPLE_ALPHA_TO_COVERAGE):ae(t.SAMPLE_ALPHA_TO_COVERAGE)}function Ee(I){M!==I&&(I?t.frontFace(t.CW):t.frontFace(t.CCW),M=I)}function ge(I){I!==ay?(Z(t.CULL_FACE),I!==D&&(I===wp?t.cullFace(t.BACK):I===ly?t.cullFace(t.FRONT):t.cullFace(t.FRONT_AND_BACK))):ae(t.CULL_FACE),D=I}function Ze(I){I!==k&&(z&&t.lineWidth(I),k=I)}function de(I,oe,ce){I?(Z(t.POLYGON_OFFSET_FILL),(H!==oe||V!==ce)&&(t.polygonOffset(oe,ce),H=oe,V=ce)):ae(t.POLYGON_OFFSET_FILL)}function Ie(I){I?Z(t.SCISSOR_TEST):ae(t.SCISSOR_TEST)}function wt(I){I===void 0&&(I=t.TEXTURE0+O-1),X!==I&&(t.activeTexture(I),X=I)}function pt(I,oe,ce){ce===void 0&&(X===null?ce=t.TEXTURE0+O-1:ce=X);let ye=Q[ce];ye===void 0&&(ye={type:void 0,texture:void 0},Q[ce]=ye),(ye.type!==I||ye.texture!==oe)&&(X!==ce&&(t.activeTexture(ce),X=ce),t.bindTexture(I,oe||j[I]),ye.type=I,ye.texture=oe)}function C(){const I=Q[X];I!==void 0&&I.type!==void 0&&(t.bindTexture(I.type,null),I.type=void 0,I.texture=void 0)}function S(){try{t.compressedTexImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function B(){try{t.compressedTexImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function q(){try{t.texSubImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function te(){try{t.texSubImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function $(){try{t.compressedTexSubImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ce(){try{t.compressedTexSubImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function le(){try{t.texStorage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function we(){try{t.texStorage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function Ae(){try{t.texImage2D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function se(){try{t.texImage3D(...arguments)}catch(I){console.error("THREE.WebGLState:",I)}}function _e(I){je.equals(I)===!1&&(t.scissor(I.x,I.y,I.z,I.w),je.copy(I))}function Fe(I){Oe.equals(I)===!1&&(t.viewport(I.x,I.y,I.z,I.w),Oe.copy(I))}function Re(I,oe){let ce=c.get(oe);ce===void 0&&(ce=new WeakMap,c.set(oe,ce));let ye=ce.get(I);ye===void 0&&(ye=t.getUniformBlockIndex(oe,I.name),ce.set(I,ye))}function pe(I,oe){const ye=c.get(oe).get(I);l.get(oe)!==ye&&(t.uniformBlockBinding(oe,ye,I.__bindingPointIndex),l.set(oe,ye))}function He(){t.disable(t.BLEND),t.disable(t.CULL_FACE),t.disable(t.DEPTH_TEST),t.disable(t.POLYGON_OFFSET_FILL),t.disable(t.SCISSOR_TEST),t.disable(t.STENCIL_TEST),t.disable(t.SAMPLE_ALPHA_TO_COVERAGE),t.blendEquation(t.FUNC_ADD),t.blendFunc(t.ONE,t.ZERO),t.blendFuncSeparate(t.ONE,t.ZERO,t.ONE,t.ZERO),t.blendColor(0,0,0,0),t.colorMask(!0,!0,!0,!0),t.clearColor(0,0,0,0),t.depthMask(!0),t.depthFunc(t.LESS),o.setReversed(!1),t.clearDepth(1),t.stencilMask(4294967295),t.stencilFunc(t.ALWAYS,0,4294967295),t.stencilOp(t.KEEP,t.KEEP,t.KEEP),t.clearStencil(0),t.cullFace(t.BACK),t.frontFace(t.CCW),t.polygonOffset(0,0),t.activeTexture(t.TEXTURE0),t.bindFramebuffer(t.FRAMEBUFFER,null),t.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),t.bindFramebuffer(t.READ_FRAMEBUFFER,null),t.useProgram(null),t.lineWidth(1),t.scissor(0,0,t.canvas.width,t.canvas.height),t.viewport(0,0,t.canvas.width,t.canvas.height),h={},X=null,Q={},f={},d=new WeakMap,p=[],_=null,g=!1,m=null,u=null,v=null,x=null,y=null,T=null,R=null,A=new Qe(0,0,0),P=0,w=!1,M=null,D=null,k=null,H=null,V=null,je.set(0,0,t.canvas.width,t.canvas.height),Oe.set(0,0,t.canvas.width,t.canvas.height),s.reset(),o.reset(),a.reset()}return{buffers:{color:s,depth:o,stencil:a},enable:Z,disable:ae,bindFramebuffer:Te,drawBuffers:ue,useProgram:Le,setBlending:$e,setMaterial:Ue,setFlipSided:Ee,setCullFace:ge,setLineWidth:Ze,setPolygonOffset:de,setScissorTest:Ie,activeTexture:wt,bindTexture:pt,unbindTexture:C,compressedTexImage2D:S,compressedTexImage3D:B,texImage2D:Ae,texImage3D:se,updateUBOMapping:Re,uniformBlockBinding:pe,texStorage2D:le,texStorage3D:we,texSubImage2D:q,texSubImage3D:te,compressedTexSubImage2D:$,compressedTexSubImage3D:Ce,scissor:_e,viewport:Fe,reset:He}}function TT(t,e,n,i,r,s,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new Be,h=new WeakMap;let f;const d=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function _(C,S){return p?new OffscreenCanvas(C,S):Ll("canvas")}function g(C,S,B){let q=1;const te=pt(C);if((te.width>B||te.height>B)&&(q=B/Math.max(te.width,te.height)),q<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const $=Math.floor(q*te.width),Ce=Math.floor(q*te.height);f===void 0&&(f=_($,Ce));const le=S?_($,Ce):f;return le.width=$,le.height=Ce,le.getContext("2d").drawImage(C,0,0,$,Ce),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+te.width+"x"+te.height+") to ("+$+"x"+Ce+")."),le}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+te.width+"x"+te.height+")."),C;return C}function m(C){return C.generateMipmaps}function u(C){t.generateMipmap(C)}function v(C){return C.isWebGLCubeRenderTarget?t.TEXTURE_CUBE_MAP:C.isWebGL3DRenderTarget?t.TEXTURE_3D:C.isWebGLArrayRenderTarget||C.isCompressedArrayTexture?t.TEXTURE_2D_ARRAY:t.TEXTURE_2D}function x(C,S,B,q,te=!1){if(C!==null){if(t[C]!==void 0)return t[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let $=S;if(S===t.RED&&(B===t.FLOAT&&($=t.R32F),B===t.HALF_FLOAT&&($=t.R16F),B===t.UNSIGNED_BYTE&&($=t.R8)),S===t.RED_INTEGER&&(B===t.UNSIGNED_BYTE&&($=t.R8UI),B===t.UNSIGNED_SHORT&&($=t.R16UI),B===t.UNSIGNED_INT&&($=t.R32UI),B===t.BYTE&&($=t.R8I),B===t.SHORT&&($=t.R16I),B===t.INT&&($=t.R32I)),S===t.RG&&(B===t.FLOAT&&($=t.RG32F),B===t.HALF_FLOAT&&($=t.RG16F),B===t.UNSIGNED_BYTE&&($=t.RG8)),S===t.RG_INTEGER&&(B===t.UNSIGNED_BYTE&&($=t.RG8UI),B===t.UNSIGNED_SHORT&&($=t.RG16UI),B===t.UNSIGNED_INT&&($=t.RG32UI),B===t.BYTE&&($=t.RG8I),B===t.SHORT&&($=t.RG16I),B===t.INT&&($=t.RG32I)),S===t.RGB_INTEGER&&(B===t.UNSIGNED_BYTE&&($=t.RGB8UI),B===t.UNSIGNED_SHORT&&($=t.RGB16UI),B===t.UNSIGNED_INT&&($=t.RGB32UI),B===t.BYTE&&($=t.RGB8I),B===t.SHORT&&($=t.RGB16I),B===t.INT&&($=t.RGB32I)),S===t.RGBA_INTEGER&&(B===t.UNSIGNED_BYTE&&($=t.RGBA8UI),B===t.UNSIGNED_SHORT&&($=t.RGBA16UI),B===t.UNSIGNED_INT&&($=t.RGBA32UI),B===t.BYTE&&($=t.RGBA8I),B===t.SHORT&&($=t.RGBA16I),B===t.INT&&($=t.RGBA32I)),S===t.RGB&&(B===t.UNSIGNED_INT_5_9_9_9_REV&&($=t.RGB9_E5),B===t.UNSIGNED_INT_10F_11F_11F_REV&&($=t.R11F_G11F_B10F)),S===t.RGBA){const Ce=te?bl:tt.getTransfer(q);B===t.FLOAT&&($=t.RGBA32F),B===t.HALF_FLOAT&&($=t.RGBA16F),B===t.UNSIGNED_BYTE&&($=Ce===st?t.SRGB8_ALPHA8:t.RGBA8),B===t.UNSIGNED_SHORT_4_4_4_4&&($=t.RGBA4),B===t.UNSIGNED_SHORT_5_5_5_1&&($=t.RGB5_A1)}return($===t.R16F||$===t.R32F||$===t.RG16F||$===t.RG32F||$===t.RGBA16F||$===t.RGBA32F)&&e.get("EXT_color_buffer_float"),$}function y(C,S){let B;return C?S===null||S===br||S===Bo?B=t.DEPTH24_STENCIL8:S===gi?B=t.DEPTH32F_STENCIL8:S===ko&&(B=t.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):S===null||S===br||S===Bo?B=t.DEPTH_COMPONENT24:S===gi?B=t.DEPTH_COMPONENT32F:S===ko&&(B=t.DEPTH_COMPONENT16),B}function T(C,S){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==Xn&&C.minFilter!==Jn?Math.log2(Math.max(S.width,S.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?S.mipmaps.length:1}function R(C){const S=C.target;S.removeEventListener("dispose",R),P(S),S.isVideoTexture&&h.delete(S)}function A(C){const S=C.target;S.removeEventListener("dispose",A),M(S)}function P(C){const S=i.get(C);if(S.__webglInit===void 0)return;const B=C.source,q=d.get(B);if(q){const te=q[S.__cacheKey];te.usedTimes--,te.usedTimes===0&&w(C),Object.keys(q).length===0&&d.delete(B)}i.remove(C)}function w(C){const S=i.get(C);t.deleteTexture(S.__webglTexture);const B=C.source,q=d.get(B);delete q[S.__cacheKey],o.memory.textures--}function M(C){const S=i.get(C);if(C.depthTexture&&(C.depthTexture.dispose(),i.remove(C.depthTexture)),C.isWebGLCubeRenderTarget)for(let q=0;q<6;q++){if(Array.isArray(S.__webglFramebuffer[q]))for(let te=0;te<S.__webglFramebuffer[q].length;te++)t.deleteFramebuffer(S.__webglFramebuffer[q][te]);else t.deleteFramebuffer(S.__webglFramebuffer[q]);S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer[q])}else{if(Array.isArray(S.__webglFramebuffer))for(let q=0;q<S.__webglFramebuffer.length;q++)t.deleteFramebuffer(S.__webglFramebuffer[q]);else t.deleteFramebuffer(S.__webglFramebuffer);if(S.__webglDepthbuffer&&t.deleteRenderbuffer(S.__webglDepthbuffer),S.__webglMultisampledFramebuffer&&t.deleteFramebuffer(S.__webglMultisampledFramebuffer),S.__webglColorRenderbuffer)for(let q=0;q<S.__webglColorRenderbuffer.length;q++)S.__webglColorRenderbuffer[q]&&t.deleteRenderbuffer(S.__webglColorRenderbuffer[q]);S.__webglDepthRenderbuffer&&t.deleteRenderbuffer(S.__webglDepthRenderbuffer)}const B=C.textures;for(let q=0,te=B.length;q<te;q++){const $=i.get(B[q]);$.__webglTexture&&(t.deleteTexture($.__webglTexture),o.memory.textures--),i.remove(B[q])}i.remove(C)}let D=0;function k(){D=0}function H(){const C=D;return C>=r.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+r.maxTextures),D+=1,C}function V(C){const S=[];return S.push(C.wrapS),S.push(C.wrapT),S.push(C.wrapR||0),S.push(C.magFilter),S.push(C.minFilter),S.push(C.anisotropy),S.push(C.internalFormat),S.push(C.format),S.push(C.type),S.push(C.generateMipmaps),S.push(C.premultiplyAlpha),S.push(C.flipY),S.push(C.unpackAlignment),S.push(C.colorSpace),S.join()}function O(C,S){const B=i.get(C);if(C.isVideoTexture&&Ie(C),C.isRenderTargetTexture===!1&&C.isExternalTexture!==!0&&C.version>0&&B.__version!==C.version){const q=C.image;if(q===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(q.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{j(B,C,S);return}}else C.isExternalTexture&&(B.__webglTexture=C.sourceTexture?C.sourceTexture:null);n.bindTexture(t.TEXTURE_2D,B.__webglTexture,t.TEXTURE0+S)}function z(C,S){const B=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&B.__version!==C.version){j(B,C,S);return}n.bindTexture(t.TEXTURE_2D_ARRAY,B.__webglTexture,t.TEXTURE0+S)}function Y(C,S){const B=i.get(C);if(C.isRenderTargetTexture===!1&&C.version>0&&B.__version!==C.version){j(B,C,S);return}n.bindTexture(t.TEXTURE_3D,B.__webglTexture,t.TEXTURE0+S)}function L(C,S){const B=i.get(C);if(C.version>0&&B.__version!==C.version){Z(B,C,S);return}n.bindTexture(t.TEXTURE_CUBE_MAP,B.__webglTexture,t.TEXTURE0+S)}const X={[_f]:t.REPEAT,[yr]:t.CLAMP_TO_EDGE,[gf]:t.MIRRORED_REPEAT},Q={[Xn]:t.NEAREST,[Fy]:t.NEAREST_MIPMAP_NEAREST,[ma]:t.NEAREST_MIPMAP_LINEAR,[Jn]:t.LINEAR,[bc]:t.LINEAR_MIPMAP_NEAREST,[Sr]:t.LINEAR_MIPMAP_LINEAR},K={[zy]:t.NEVER,[jy]:t.ALWAYS,[Hy]:t.LESS,[n0]:t.LEQUAL,[Vy]:t.EQUAL,[Xy]:t.GEQUAL,[Gy]:t.GREATER,[Wy]:t.NOTEQUAL};function ee(C,S){if(S.type===gi&&e.has("OES_texture_float_linear")===!1&&(S.magFilter===Jn||S.magFilter===bc||S.magFilter===ma||S.magFilter===Sr||S.minFilter===Jn||S.minFilter===bc||S.minFilter===ma||S.minFilter===Sr)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),t.texParameteri(C,t.TEXTURE_WRAP_S,X[S.wrapS]),t.texParameteri(C,t.TEXTURE_WRAP_T,X[S.wrapT]),(C===t.TEXTURE_3D||C===t.TEXTURE_2D_ARRAY)&&t.texParameteri(C,t.TEXTURE_WRAP_R,X[S.wrapR]),t.texParameteri(C,t.TEXTURE_MAG_FILTER,Q[S.magFilter]),t.texParameteri(C,t.TEXTURE_MIN_FILTER,Q[S.minFilter]),S.compareFunction&&(t.texParameteri(C,t.TEXTURE_COMPARE_MODE,t.COMPARE_REF_TO_TEXTURE),t.texParameteri(C,t.TEXTURE_COMPARE_FUNC,K[S.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(S.magFilter===Xn||S.minFilter!==ma&&S.minFilter!==Sr||S.type===gi&&e.has("OES_texture_float_linear")===!1)return;if(S.anisotropy>1||i.get(S).__currentAnisotropy){const B=e.get("EXT_texture_filter_anisotropic");t.texParameterf(C,B.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(S.anisotropy,r.getMaxAnisotropy())),i.get(S).__currentAnisotropy=S.anisotropy}}}function je(C,S){let B=!1;C.__webglInit===void 0&&(C.__webglInit=!0,S.addEventListener("dispose",R));const q=S.source;let te=d.get(q);te===void 0&&(te={},d.set(q,te));const $=V(S);if($!==C.__cacheKey){te[$]===void 0&&(te[$]={texture:t.createTexture(),usedTimes:0},o.memory.textures++,B=!0),te[$].usedTimes++;const Ce=te[C.__cacheKey];Ce!==void 0&&(te[C.__cacheKey].usedTimes--,Ce.usedTimes===0&&w(S)),C.__cacheKey=$,C.__webglTexture=te[$].texture}return B}function Oe(C,S,B){return Math.floor(Math.floor(C/B)/S)}function be(C,S,B,q){const $=C.updateRanges;if($.length===0)n.texSubImage2D(t.TEXTURE_2D,0,0,0,S.width,S.height,B,q,S.data);else{$.sort((se,_e)=>se.start-_e.start);let Ce=0;for(let se=1;se<$.length;se++){const _e=$[Ce],Fe=$[se],Re=_e.start+_e.count,pe=Oe(Fe.start,S.width,4),He=Oe(_e.start,S.width,4);Fe.start<=Re+1&&pe===He&&Oe(Fe.start+Fe.count-1,S.width,4)===pe?_e.count=Math.max(_e.count,Fe.start+Fe.count-_e.start):(++Ce,$[Ce]=Fe)}$.length=Ce+1;const le=t.getParameter(t.UNPACK_ROW_LENGTH),we=t.getParameter(t.UNPACK_SKIP_PIXELS),Ae=t.getParameter(t.UNPACK_SKIP_ROWS);t.pixelStorei(t.UNPACK_ROW_LENGTH,S.width);for(let se=0,_e=$.length;se<_e;se++){const Fe=$[se],Re=Math.floor(Fe.start/4),pe=Math.ceil(Fe.count/4),He=Re%S.width,I=Math.floor(Re/S.width),oe=pe,ce=1;t.pixelStorei(t.UNPACK_SKIP_PIXELS,He),t.pixelStorei(t.UNPACK_SKIP_ROWS,I),n.texSubImage2D(t.TEXTURE_2D,0,He,I,oe,ce,B,q,S.data)}C.clearUpdateRanges(),t.pixelStorei(t.UNPACK_ROW_LENGTH,le),t.pixelStorei(t.UNPACK_SKIP_PIXELS,we),t.pixelStorei(t.UNPACK_SKIP_ROWS,Ae)}}function j(C,S,B){let q=t.TEXTURE_2D;(S.isDataArrayTexture||S.isCompressedArrayTexture)&&(q=t.TEXTURE_2D_ARRAY),S.isData3DTexture&&(q=t.TEXTURE_3D);const te=je(C,S),$=S.source;n.bindTexture(q,C.__webglTexture,t.TEXTURE0+B);const Ce=i.get($);if($.version!==Ce.__version||te===!0){n.activeTexture(t.TEXTURE0+B);const le=tt.getPrimaries(tt.workingColorSpace),we=S.colorSpace===Oi?null:tt.getPrimaries(S.colorSpace),Ae=S.colorSpace===Oi||le===we?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ae);let se=g(S.image,!1,r.maxTextureSize);se=wt(S,se);const _e=s.convert(S.format,S.colorSpace),Fe=s.convert(S.type);let Re=x(S.internalFormat,_e,Fe,S.colorSpace,S.isVideoTexture);ee(q,S);let pe;const He=S.mipmaps,I=S.isVideoTexture!==!0,oe=Ce.__version===void 0||te===!0,ce=$.dataReady,ye=T(S,se);if(S.isDepthTexture)Re=y(S.format===Ho,S.type),oe&&(I?n.texStorage2D(t.TEXTURE_2D,1,Re,se.width,se.height):n.texImage2D(t.TEXTURE_2D,0,Re,se.width,se.height,0,_e,Fe,null));else if(S.isDataTexture)if(He.length>0){I&&oe&&n.texStorage2D(t.TEXTURE_2D,ye,Re,He[0].width,He[0].height);for(let ie=0,J=He.length;ie<J;ie++)pe=He[ie],I?ce&&n.texSubImage2D(t.TEXTURE_2D,ie,0,0,pe.width,pe.height,_e,Fe,pe.data):n.texImage2D(t.TEXTURE_2D,ie,Re,pe.width,pe.height,0,_e,Fe,pe.data);S.generateMipmaps=!1}else I?(oe&&n.texStorage2D(t.TEXTURE_2D,ye,Re,se.width,se.height),ce&&be(S,se,_e,Fe)):n.texImage2D(t.TEXTURE_2D,0,Re,se.width,se.height,0,_e,Fe,se.data);else if(S.isCompressedTexture)if(S.isCompressedArrayTexture){I&&oe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ye,Re,He[0].width,He[0].height,se.depth);for(let ie=0,J=He.length;ie<J;ie++)if(pe=He[ie],S.format!==Vn)if(_e!==null)if(I){if(ce)if(S.layerUpdates.size>0){const Me=nm(pe.width,pe.height,S.format,S.type);for(const ze of S.layerUpdates){const ct=pe.data.subarray(ze*Me/pe.data.BYTES_PER_ELEMENT,(ze+1)*Me/pe.data.BYTES_PER_ELEMENT);n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ie,0,0,ze,pe.width,pe.height,1,_e,ct)}S.clearLayerUpdates()}else n.compressedTexSubImage3D(t.TEXTURE_2D_ARRAY,ie,0,0,0,pe.width,pe.height,se.depth,_e,pe.data)}else n.compressedTexImage3D(t.TEXTURE_2D_ARRAY,ie,Re,pe.width,pe.height,se.depth,0,pe.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else I?ce&&n.texSubImage3D(t.TEXTURE_2D_ARRAY,ie,0,0,0,pe.width,pe.height,se.depth,_e,Fe,pe.data):n.texImage3D(t.TEXTURE_2D_ARRAY,ie,Re,pe.width,pe.height,se.depth,0,_e,Fe,pe.data)}else{I&&oe&&n.texStorage2D(t.TEXTURE_2D,ye,Re,He[0].width,He[0].height);for(let ie=0,J=He.length;ie<J;ie++)pe=He[ie],S.format!==Vn?_e!==null?I?ce&&n.compressedTexSubImage2D(t.TEXTURE_2D,ie,0,0,pe.width,pe.height,_e,pe.data):n.compressedTexImage2D(t.TEXTURE_2D,ie,Re,pe.width,pe.height,0,pe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):I?ce&&n.texSubImage2D(t.TEXTURE_2D,ie,0,0,pe.width,pe.height,_e,Fe,pe.data):n.texImage2D(t.TEXTURE_2D,ie,Re,pe.width,pe.height,0,_e,Fe,pe.data)}else if(S.isDataArrayTexture)if(I){if(oe&&n.texStorage3D(t.TEXTURE_2D_ARRAY,ye,Re,se.width,se.height,se.depth),ce)if(S.layerUpdates.size>0){const ie=nm(se.width,se.height,S.format,S.type);for(const J of S.layerUpdates){const Me=se.data.subarray(J*ie/se.data.BYTES_PER_ELEMENT,(J+1)*ie/se.data.BYTES_PER_ELEMENT);n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,J,se.width,se.height,1,_e,Fe,Me)}S.clearLayerUpdates()}else n.texSubImage3D(t.TEXTURE_2D_ARRAY,0,0,0,0,se.width,se.height,se.depth,_e,Fe,se.data)}else n.texImage3D(t.TEXTURE_2D_ARRAY,0,Re,se.width,se.height,se.depth,0,_e,Fe,se.data);else if(S.isData3DTexture)I?(oe&&n.texStorage3D(t.TEXTURE_3D,ye,Re,se.width,se.height,se.depth),ce&&n.texSubImage3D(t.TEXTURE_3D,0,0,0,0,se.width,se.height,se.depth,_e,Fe,se.data)):n.texImage3D(t.TEXTURE_3D,0,Re,se.width,se.height,se.depth,0,_e,Fe,se.data);else if(S.isFramebufferTexture){if(oe)if(I)n.texStorage2D(t.TEXTURE_2D,ye,Re,se.width,se.height);else{let ie=se.width,J=se.height;for(let Me=0;Me<ye;Me++)n.texImage2D(t.TEXTURE_2D,Me,Re,ie,J,0,_e,Fe,null),ie>>=1,J>>=1}}else if(He.length>0){if(I&&oe){const ie=pt(He[0]);n.texStorage2D(t.TEXTURE_2D,ye,Re,ie.width,ie.height)}for(let ie=0,J=He.length;ie<J;ie++)pe=He[ie],I?ce&&n.texSubImage2D(t.TEXTURE_2D,ie,0,0,_e,Fe,pe):n.texImage2D(t.TEXTURE_2D,ie,Re,_e,Fe,pe);S.generateMipmaps=!1}else if(I){if(oe){const ie=pt(se);n.texStorage2D(t.TEXTURE_2D,ye,Re,ie.width,ie.height)}ce&&n.texSubImage2D(t.TEXTURE_2D,0,0,0,_e,Fe,se)}else n.texImage2D(t.TEXTURE_2D,0,Re,_e,Fe,se);m(S)&&u(q),Ce.__version=$.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function Z(C,S,B){if(S.image.length!==6)return;const q=je(C,S),te=S.source;n.bindTexture(t.TEXTURE_CUBE_MAP,C.__webglTexture,t.TEXTURE0+B);const $=i.get(te);if(te.version!==$.__version||q===!0){n.activeTexture(t.TEXTURE0+B);const Ce=tt.getPrimaries(tt.workingColorSpace),le=S.colorSpace===Oi?null:tt.getPrimaries(S.colorSpace),we=S.colorSpace===Oi||Ce===le?t.NONE:t.BROWSER_DEFAULT_WEBGL;t.pixelStorei(t.UNPACK_FLIP_Y_WEBGL,S.flipY),t.pixelStorei(t.UNPACK_PREMULTIPLY_ALPHA_WEBGL,S.premultiplyAlpha),t.pixelStorei(t.UNPACK_ALIGNMENT,S.unpackAlignment),t.pixelStorei(t.UNPACK_COLORSPACE_CONVERSION_WEBGL,we);const Ae=S.isCompressedTexture||S.image[0].isCompressedTexture,se=S.image[0]&&S.image[0].isDataTexture,_e=[];for(let J=0;J<6;J++)!Ae&&!se?_e[J]=g(S.image[J],!0,r.maxCubemapSize):_e[J]=se?S.image[J].image:S.image[J],_e[J]=wt(S,_e[J]);const Fe=_e[0],Re=s.convert(S.format,S.colorSpace),pe=s.convert(S.type),He=x(S.internalFormat,Re,pe,S.colorSpace),I=S.isVideoTexture!==!0,oe=$.__version===void 0||q===!0,ce=te.dataReady;let ye=T(S,Fe);ee(t.TEXTURE_CUBE_MAP,S);let ie;if(Ae){I&&oe&&n.texStorage2D(t.TEXTURE_CUBE_MAP,ye,He,Fe.width,Fe.height);for(let J=0;J<6;J++){ie=_e[J].mipmaps;for(let Me=0;Me<ie.length;Me++){const ze=ie[Me];S.format!==Vn?Re!==null?I?ce&&n.compressedTexSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,Me,0,0,ze.width,ze.height,Re,ze.data):n.compressedTexImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,Me,He,ze.width,ze.height,0,ze.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):I?ce&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,Me,0,0,ze.width,ze.height,Re,pe,ze.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,Me,He,ze.width,ze.height,0,Re,pe,ze.data)}}}else{if(ie=S.mipmaps,I&&oe){ie.length>0&&ye++;const J=pt(_e[0]);n.texStorage2D(t.TEXTURE_CUBE_MAP,ye,He,J.width,J.height)}for(let J=0;J<6;J++)if(se){I?ce&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,_e[J].width,_e[J].height,Re,pe,_e[J].data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,He,_e[J].width,_e[J].height,0,Re,pe,_e[J].data);for(let Me=0;Me<ie.length;Me++){const ct=ie[Me].image[J].image;I?ce&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,Me+1,0,0,ct.width,ct.height,Re,pe,ct.data):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,Me+1,He,ct.width,ct.height,0,Re,pe,ct.data)}}else{I?ce&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,0,0,Re,pe,_e[J]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,0,He,Re,pe,_e[J]);for(let Me=0;Me<ie.length;Me++){const ze=ie[Me];I?ce&&n.texSubImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,Me+1,0,0,Re,pe,ze.image[J]):n.texImage2D(t.TEXTURE_CUBE_MAP_POSITIVE_X+J,Me+1,He,Re,pe,ze.image[J])}}}m(S)&&u(t.TEXTURE_CUBE_MAP),$.__version=te.version,S.onUpdate&&S.onUpdate(S)}C.__version=S.version}function ae(C,S,B,q,te,$){const Ce=s.convert(B.format,B.colorSpace),le=s.convert(B.type),we=x(B.internalFormat,Ce,le,B.colorSpace),Ae=i.get(S),se=i.get(B);if(se.__renderTarget=S,!Ae.__hasExternalTextures){const _e=Math.max(1,S.width>>$),Fe=Math.max(1,S.height>>$);te===t.TEXTURE_3D||te===t.TEXTURE_2D_ARRAY?n.texImage3D(te,$,we,_e,Fe,S.depth,0,Ce,le,null):n.texImage2D(te,$,we,_e,Fe,0,Ce,le,null)}n.bindFramebuffer(t.FRAMEBUFFER,C),de(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,q,te,se.__webglTexture,0,Ze(S)):(te===t.TEXTURE_2D||te>=t.TEXTURE_CUBE_MAP_POSITIVE_X&&te<=t.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&t.framebufferTexture2D(t.FRAMEBUFFER,q,te,se.__webglTexture,$),n.bindFramebuffer(t.FRAMEBUFFER,null)}function Te(C,S,B){if(t.bindRenderbuffer(t.RENDERBUFFER,C),S.depthBuffer){const q=S.depthTexture,te=q&&q.isDepthTexture?q.type:null,$=y(S.stencilBuffer,te),Ce=S.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,le=Ze(S);de(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,le,$,S.width,S.height):B?t.renderbufferStorageMultisample(t.RENDERBUFFER,le,$,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,$,S.width,S.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,Ce,t.RENDERBUFFER,C)}else{const q=S.textures;for(let te=0;te<q.length;te++){const $=q[te],Ce=s.convert($.format,$.colorSpace),le=s.convert($.type),we=x($.internalFormat,Ce,le,$.colorSpace),Ae=Ze(S);B&&de(S)===!1?t.renderbufferStorageMultisample(t.RENDERBUFFER,Ae,we,S.width,S.height):de(S)?a.renderbufferStorageMultisampleEXT(t.RENDERBUFFER,Ae,we,S.width,S.height):t.renderbufferStorage(t.RENDERBUFFER,we,S.width,S.height)}}t.bindRenderbuffer(t.RENDERBUFFER,null)}function ue(C,S){if(S&&S.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(n.bindFramebuffer(t.FRAMEBUFFER,C),!(S.depthTexture&&S.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const q=i.get(S.depthTexture);q.__renderTarget=S,(!q.__webglTexture||S.depthTexture.image.width!==S.width||S.depthTexture.image.height!==S.height)&&(S.depthTexture.image.width=S.width,S.depthTexture.image.height=S.height,S.depthTexture.needsUpdate=!0),O(S.depthTexture,0);const te=q.__webglTexture,$=Ze(S);if(S.depthTexture.format===zo)de(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,te,0,$):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_ATTACHMENT,t.TEXTURE_2D,te,0);else if(S.depthTexture.format===Ho)de(S)?a.framebufferTexture2DMultisampleEXT(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,te,0,$):t.framebufferTexture2D(t.FRAMEBUFFER,t.DEPTH_STENCIL_ATTACHMENT,t.TEXTURE_2D,te,0);else throw new Error("Unknown depthTexture format")}function Le(C){const S=i.get(C),B=C.isWebGLCubeRenderTarget===!0;if(S.__boundDepthTexture!==C.depthTexture){const q=C.depthTexture;if(S.__depthDisposeCallback&&S.__depthDisposeCallback(),q){const te=()=>{delete S.__boundDepthTexture,delete S.__depthDisposeCallback,q.removeEventListener("dispose",te)};q.addEventListener("dispose",te),S.__depthDisposeCallback=te}S.__boundDepthTexture=q}if(C.depthTexture&&!S.__autoAllocateDepthBuffer){if(B)throw new Error("target.depthTexture not supported in Cube render targets");const q=C.texture.mipmaps;q&&q.length>0?ue(S.__webglFramebuffer[0],C):ue(S.__webglFramebuffer,C)}else if(B){S.__webglDepthbuffer=[];for(let q=0;q<6;q++)if(n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[q]),S.__webglDepthbuffer[q]===void 0)S.__webglDepthbuffer[q]=t.createRenderbuffer(),Te(S.__webglDepthbuffer[q],C,!1);else{const te=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,$=S.__webglDepthbuffer[q];t.bindRenderbuffer(t.RENDERBUFFER,$),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,$)}}else{const q=C.texture.mipmaps;if(q&&q.length>0?n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer[0]):n.bindFramebuffer(t.FRAMEBUFFER,S.__webglFramebuffer),S.__webglDepthbuffer===void 0)S.__webglDepthbuffer=t.createRenderbuffer(),Te(S.__webglDepthbuffer,C,!1);else{const te=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,$=S.__webglDepthbuffer;t.bindRenderbuffer(t.RENDERBUFFER,$),t.framebufferRenderbuffer(t.FRAMEBUFFER,te,t.RENDERBUFFER,$)}}n.bindFramebuffer(t.FRAMEBUFFER,null)}function Ye(C,S,B){const q=i.get(C);S!==void 0&&ae(q.__webglFramebuffer,C,C.texture,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,0),B!==void 0&&Le(C)}function b(C){const S=C.texture,B=i.get(C),q=i.get(S);C.addEventListener("dispose",A);const te=C.textures,$=C.isWebGLCubeRenderTarget===!0,Ce=te.length>1;if(Ce||(q.__webglTexture===void 0&&(q.__webglTexture=t.createTexture()),q.__version=S.version,o.memory.textures++),$){B.__webglFramebuffer=[];for(let le=0;le<6;le++)if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer[le]=[];for(let we=0;we<S.mipmaps.length;we++)B.__webglFramebuffer[le][we]=t.createFramebuffer()}else B.__webglFramebuffer[le]=t.createFramebuffer()}else{if(S.mipmaps&&S.mipmaps.length>0){B.__webglFramebuffer=[];for(let le=0;le<S.mipmaps.length;le++)B.__webglFramebuffer[le]=t.createFramebuffer()}else B.__webglFramebuffer=t.createFramebuffer();if(Ce)for(let le=0,we=te.length;le<we;le++){const Ae=i.get(te[le]);Ae.__webglTexture===void 0&&(Ae.__webglTexture=t.createTexture(),o.memory.textures++)}if(C.samples>0&&de(C)===!1){B.__webglMultisampledFramebuffer=t.createFramebuffer(),B.__webglColorRenderbuffer=[],n.bindFramebuffer(t.FRAMEBUFFER,B.__webglMultisampledFramebuffer);for(let le=0;le<te.length;le++){const we=te[le];B.__webglColorRenderbuffer[le]=t.createRenderbuffer(),t.bindRenderbuffer(t.RENDERBUFFER,B.__webglColorRenderbuffer[le]);const Ae=s.convert(we.format,we.colorSpace),se=s.convert(we.type),_e=x(we.internalFormat,Ae,se,we.colorSpace,C.isXRRenderTarget===!0),Fe=Ze(C);t.renderbufferStorageMultisample(t.RENDERBUFFER,Fe,_e,C.width,C.height),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+le,t.RENDERBUFFER,B.__webglColorRenderbuffer[le])}t.bindRenderbuffer(t.RENDERBUFFER,null),C.depthBuffer&&(B.__webglDepthRenderbuffer=t.createRenderbuffer(),Te(B.__webglDepthRenderbuffer,C,!0)),n.bindFramebuffer(t.FRAMEBUFFER,null)}}if($){n.bindTexture(t.TEXTURE_CUBE_MAP,q.__webglTexture),ee(t.TEXTURE_CUBE_MAP,S);for(let le=0;le<6;le++)if(S.mipmaps&&S.mipmaps.length>0)for(let we=0;we<S.mipmaps.length;we++)ae(B.__webglFramebuffer[le][we],C,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+le,we);else ae(B.__webglFramebuffer[le],C,S,t.COLOR_ATTACHMENT0,t.TEXTURE_CUBE_MAP_POSITIVE_X+le,0);m(S)&&u(t.TEXTURE_CUBE_MAP),n.unbindTexture()}else if(Ce){for(let le=0,we=te.length;le<we;le++){const Ae=te[le],se=i.get(Ae);let _e=t.TEXTURE_2D;(C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(_e=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(_e,se.__webglTexture),ee(_e,Ae),ae(B.__webglFramebuffer,C,Ae,t.COLOR_ATTACHMENT0+le,_e,0),m(Ae)&&u(_e)}n.unbindTexture()}else{let le=t.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(le=C.isWebGL3DRenderTarget?t.TEXTURE_3D:t.TEXTURE_2D_ARRAY),n.bindTexture(le,q.__webglTexture),ee(le,S),S.mipmaps&&S.mipmaps.length>0)for(let we=0;we<S.mipmaps.length;we++)ae(B.__webglFramebuffer[we],C,S,t.COLOR_ATTACHMENT0,le,we);else ae(B.__webglFramebuffer,C,S,t.COLOR_ATTACHMENT0,le,0);m(S)&&u(le),n.unbindTexture()}C.depthBuffer&&Le(C)}function $e(C){const S=C.textures;for(let B=0,q=S.length;B<q;B++){const te=S[B];if(m(te)){const $=v(C),Ce=i.get(te).__webglTexture;n.bindTexture($,Ce),u($),n.unbindTexture()}}}const Ue=[],Ee=[];function ge(C){if(C.samples>0){if(de(C)===!1){const S=C.textures,B=C.width,q=C.height;let te=t.COLOR_BUFFER_BIT;const $=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT,Ce=i.get(C),le=S.length>1;if(le)for(let Ae=0;Ae<S.length;Ae++)n.bindFramebuffer(t.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,null),n.bindFramebuffer(t.FRAMEBUFFER,Ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,null,0);n.bindFramebuffer(t.READ_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer);const we=C.texture.mipmaps;we&&we.length>0?n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer[0]):n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ce.__webglFramebuffer);for(let Ae=0;Ae<S.length;Ae++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(te|=t.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(te|=t.STENCIL_BUFFER_BIT)),le){t.framebufferRenderbuffer(t.READ_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ae]);const se=i.get(S[Ae]).__webglTexture;t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0,t.TEXTURE_2D,se,0)}t.blitFramebuffer(0,0,B,q,0,0,B,q,te,t.NEAREST),l===!0&&(Ue.length=0,Ee.length=0,Ue.push(t.COLOR_ATTACHMENT0+Ae),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Ue.push($),Ee.push($),t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,Ee)),t.invalidateFramebuffer(t.READ_FRAMEBUFFER,Ue))}if(n.bindFramebuffer(t.READ_FRAMEBUFFER,null),n.bindFramebuffer(t.DRAW_FRAMEBUFFER,null),le)for(let Ae=0;Ae<S.length;Ae++){n.bindFramebuffer(t.FRAMEBUFFER,Ce.__webglMultisampledFramebuffer),t.framebufferRenderbuffer(t.FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.RENDERBUFFER,Ce.__webglColorRenderbuffer[Ae]);const se=i.get(S[Ae]).__webglTexture;n.bindFramebuffer(t.FRAMEBUFFER,Ce.__webglFramebuffer),t.framebufferTexture2D(t.DRAW_FRAMEBUFFER,t.COLOR_ATTACHMENT0+Ae,t.TEXTURE_2D,se,0)}n.bindFramebuffer(t.DRAW_FRAMEBUFFER,Ce.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const S=C.stencilBuffer?t.DEPTH_STENCIL_ATTACHMENT:t.DEPTH_ATTACHMENT;t.invalidateFramebuffer(t.DRAW_FRAMEBUFFER,[S])}}}function Ze(C){return Math.min(r.maxSamples,C.samples)}function de(C){const S=i.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&S.__useRenderToTexture!==!1}function Ie(C){const S=o.render.frame;h.get(C)!==S&&(h.set(C,S),C.update())}function wt(C,S){const B=C.colorSpace,q=C.format,te=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||B!==Ds&&B!==Oi&&(tt.getTransfer(B)===st?(q!==Vn||te!==ri)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",B)),S}function pt(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=H,this.resetTextureUnits=k,this.setTexture2D=O,this.setTexture2DArray=z,this.setTexture3D=Y,this.setTextureCube=L,this.rebindTextures=Ye,this.setupRenderTarget=b,this.updateRenderTargetMipmap=$e,this.updateMultisampleRenderTarget=ge,this.setupDepthRenderbuffer=Le,this.setupFrameBufferTexture=ae,this.useMultisampledRTT=de}function AT(t,e){function n(i,r=Oi){let s;const o=tt.getTransfer(r);if(i===ri)return t.UNSIGNED_BYTE;if(i===Gd)return t.UNSIGNED_SHORT_4_4_4_4;if(i===Wd)return t.UNSIGNED_SHORT_5_5_5_1;if(i===$g)return t.UNSIGNED_INT_5_9_9_9_REV;if(i===Kg)return t.UNSIGNED_INT_10F_11F_11F_REV;if(i===Yg)return t.BYTE;if(i===qg)return t.SHORT;if(i===ko)return t.UNSIGNED_SHORT;if(i===Vd)return t.INT;if(i===br)return t.UNSIGNED_INT;if(i===gi)return t.FLOAT;if(i===$o)return t.HALF_FLOAT;if(i===Zg)return t.ALPHA;if(i===Qg)return t.RGB;if(i===Vn)return t.RGBA;if(i===zo)return t.DEPTH_COMPONENT;if(i===Ho)return t.DEPTH_STENCIL;if(i===Jg)return t.RED;if(i===Xd)return t.RED_INTEGER;if(i===e0)return t.RG;if(i===jd)return t.RG_INTEGER;if(i===Yd)return t.RGBA_INTEGER;if(i===Ja||i===el||i===tl||i===nl)if(o===st)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(i===Ja)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(i===tl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(i===nl)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(i===Ja)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(i===el)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(i===tl)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(i===nl)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(i===vf||i===xf||i===yf||i===Sf)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(i===vf)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(i===xf)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(i===yf)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(i===Sf)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(i===Mf||i===Ef||i===wf)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(i===Mf||i===Ef)return o===st?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(i===wf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(i===Tf||i===Af||i===Rf||i===Cf||i===bf||i===Pf||i===Lf||i===Df||i===If||i===Nf||i===Uf||i===Ff||i===Of||i===kf)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(i===Tf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(i===Af)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(i===Rf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(i===Cf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(i===bf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(i===Pf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(i===Lf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(i===Df)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(i===If)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(i===Nf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(i===Uf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(i===Ff)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(i===Of)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(i===kf)return o===st?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(i===Bf||i===zf||i===Hf)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(i===Bf)return o===st?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(i===zf)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(i===Hf)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(i===Vf||i===Gf||i===Wf||i===Xf)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(i===Vf)return s.COMPRESSED_RED_RGTC1_EXT;if(i===Gf)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(i===Wf)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(i===Xf)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return i===Bo?t.UNSIGNED_INT_24_8:t[i]!==void 0?t[i]:null}return{convert:n}}const RT=`
void main() {
