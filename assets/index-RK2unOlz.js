(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))i(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const o of s.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&i(o)}).observe(document,{childList:!0,subtree:!0});function n(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function i(r){if(r.ep)return;r.ep=!0;const s=n(r);fetch(r.href,s)}})();var o_={exports:{}},lc={},a_={exports:{}},Ze={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(t){function e(I,Q){var re=I.length;I.push(Q);e:for(;0<re;){var Se=re-1>>>1,De=I[Se];if(0<r(De,Q))I[Se]=Q,I[re]=De,re=Se;else break e}}function n(I){return I.length===0?null:I[0]}function i(I){if(I.length===0)return null;var Q=I[0],re=I.pop();if(re!==Q){I[0]=re;e:for(var Se=0,De=I.length,Ge=De>>>1;Se<Ge;){var qe=2*(Se+1)-1,$e=I[qe],ee=qe+1,le=I[ee];if(0>r($e,re))ee<De&&0>r(le,$e)?(I[Se]=le,I[ee]=re,Se=ee):(I[Se]=$e,I[qe]=re,Se=qe);else if(ee<De&&0>r(le,re))I[Se]=le,I[ee]=re,Se=ee;else break e}}return Q}function r(I,Q){var re=I.sortIndex-Q.sortIndex;return re!==0?re:I.id-Q.id}if(typeof performance=="object"&&typeof performance.now=="function"){var s=performance;t.unstable_now=function(){return s.now()}}else{var o=Date,a=o.now();t.unstable_now=function(){return o.now()-a}}var l=[],c=[],f=1,d=null,h=3,p=!1,_=!1,g=!1,m=typeof setTimeout=="function"?setTimeout:null,u=typeof clearTimeout=="function"?clearTimeout:null,v=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function x(I){for(var Q=n(c);Q!==null;){if(Q.callback===null)i(c);else if(Q.startTime<=I)i(c),Q.sortIndex=Q.expirationTime,e(l,Q);else break;Q=n(c)}}function y(I){if(g=!1,x(I),!_)if(n(l)!==null)_=!0,X(C);else{var Q=n(c);Q!==null&&te(y,Q.startTime-I)}}function C(I,Q){_=!1,g&&(g=!1,u(b),b=-1),p=!0;var re=h;try{for(x(Q),d=n(l);d!==null&&(!(d.expirationTime>Q)||I&&!L());){var Se=d.callback;if(typeof Se=="function"){d.callback=null,h=d.priorityLevel;var De=Se(d.expirationTime<=Q);Q=t.unstable_now(),typeof De=="function"?d.callback=De:d===n(l)&&i(l),x(Q)}else i(l);d=n(l)}if(d!==null)var Ge=!0;else{var qe=n(c);qe!==null&&te(y,qe.startTime-Q),Ge=!1}return Ge}finally{d=null,h=re,p=!1}}var A=!1,R=null,b=-1,E=5,M=-1;function L(){return!(t.unstable_now()-M<E)}function O(){if(R!==null){var I=t.unstable_now();M=I;var Q=!0;try{Q=R(!0,I)}finally{Q?H():(A=!1,R=null)}}else A=!1}var H;if(typeof v=="function")H=function(){v(O)};else if(typeof MessageChannel<"u"){var J=new MessageChannel,z=J.port2;J.port1.onmessage=O,H=function(){z.postMessage(null)}}else H=function(){m(O,0)};function X(I){R=I,A||(A=!0,H())}function te(I,Q){b=m(function(){I(t.unstable_now())},Q)}t.unstable_IdlePriority=5,t.unstable_ImmediatePriority=1,t.unstable_LowPriority=4,t.unstable_NormalPriority=3,t.unstable_Profiling=null,t.unstable_UserBlockingPriority=2,t.unstable_cancelCallback=function(I){I.callback=null},t.unstable_continueExecution=function(){_||p||(_=!0,X(C))},t.unstable_forceFrameRate=function(I){0>I||125<I?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):E=0<I?Math.floor(1e3/I):5},t.unstable_getCurrentPriorityLevel=function(){return h},t.unstable_getFirstCallbackNode=function(){return n(l)},t.unstable_next=function(I){switch(h){case 1:case 2:case 3:var Q=3;break;default:Q=h}var re=h;h=Q;try{return I()}finally{h=re}},t.unstable_pauseExecution=function(){},t.unstable_requestPaint=function(){},t.unstable_runWithPriority=function(I,Q){switch(I){case 1:case 2:case 3:case 4:case 5:break;default:I=3}var re=h;h=I;try{return Q()}finally{h=re}},t.unstable_scheduleCallback=function(I,Q,re){var Se=t.unstable_now();switch(typeof re=="object"&&re!==null?(re=re.delay,re=typeof re=="number"&&0<re?Se+re:Se):re=Se,I){case 1:var De=-1;break;case 2:De=250;break;case 5:De=1073741823;break;case 4:De=1e4;break;default:De=5e3}return De=re+De,I={id:f++,callback:Q,priorityLevel:I,startTime:re,expirationTime:De,sortIndex:-1},re>Se?(I.sortIndex=re,e(c,I),n(l)===null&&I===n(c)&&(g?(u(b),b=-1):g=!0,te(y,re-Se))):(I.sortIndex=De,e(l,I),_||p||(_=!0,X(C))),I},t.unstable_shouldYield=L,t.unstable_wrapCallback=function(I){var Q=h;return function(){var re=h;h=Q;try{return I.apply(this,arguments)}finally{h=re}}}})(x_);v_.exports=x_;var Nv=v_.exports;/**
 * @license React
...
`].filter(Ro).join(`
`)),o=yh(o),o=Km(o,n),o=Zm(o,n),a=yh(a),a=Km(a,n),a=Zm(a,n),o=Jm(o),a=Jm(a),n.isRawShaderMaterial!==!0&&(v=`#version 300 es
...
`)+`
`+u);const x=v+m+o,y=v+u+a,C=Ym(r,r.VERTEX_SHADER,x),A=Ym(r,r.FRAGMENT_SHADER,y);r.attachShader(g,C),r.attachShader(g,A),n.index0AttributeName!==void 0?r.bindAttribLocation(g,0,n.index0AttributeName):n.morphTargets===!0&&r.bindAttribLocation(g,0,"position"),r.linkProgram(g);function R(L){if(t.debug.checkShaderErrors){const O=r.getProgramInfoLog(g)||"",H=r.getShaderInfoLog(C)||"",J=r.getShaderInfoLog(A)||"",z=O.trim(),X=H.trim(),te=J.trim();let I=!0,Q=!0;if(r.getProgramParameter(g,r.LINK_STATUS)===!1)if(I=!1,typeof t.debug.onShaderError=="function")t.debug.onShaderError(r,g,C,A);else{const re=$m(r,C,"vertex"),Se=$m(r,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+r.getError()+" - VALIDATE_STATUS "+r.getProgramParameter(g,r.VALIDATE_STATUS)+`
